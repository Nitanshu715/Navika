...
<div class="h"><span class="lm">◈</span><span class="ln">FINSIGHT AI</span></div>
<div class="b"><h2>{title}</h2>{body}</div>
<div class="ft">FinSight AI · Automated message · Do not reply</div>
</div></div></body></html>"""
...
def send_verification_email(to: str, name: str, token: str) -> bool:
    ...
    body    = f"""
      ...
      <p>Thanks for signing up to FinSight AI. Click below to verify your email:</p>
